...
bool GameRun::init()
{
    ...
    auto closeItem = MenuItemImage::create(
                                           "CloseNormal.png",
                                           "CloseSelected.png",
                                           CC_CALLBACK_1(GameRun::menuCloseCallback, this));
...
void GameRun::onEnter()
{
	log("GameRun onEnter");
	Layer::onEnter();
	listener = EventListenerPhysicsContact::create();
	/*listener->onContactBegin = CC_CALLBACK_0(GameRun::Game_over,this);*/
...
void GameRun::update(float delta)
{
...
bool GameRun::onTouchBegan(Touch *touch, Event *unused_event)
{
	myBird->bird_Fly();
	return true;     
}

void GameRun::onTouchMoved(Touch *touch, Event *unused_event)
{
	/*log("just move");*/
}
void GameRun::onTouchEnded(Touch *touch, Event *unused_event)
{
	/*myBird->bird_Stop();*/
	/*log("bird stop");*/
	log("the velocity is %f\n",myBird->getBird()->getPhysicsBody()->getVelocity().y);
}
void GameRun::menuCloseCallback(Ref* pSender)
{
